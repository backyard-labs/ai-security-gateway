...
An architectural reference implementation and hands-on deployment guide for an **AI Security Gateway**. Built and validated in a sandboxed lab environment with enterprise production patterns in mind, this project demonstrates how to enforce **inline PII redaction**, **virtual API key governance**, **least-privilege model scoping**, and **edge rate limiting** to mitigate critical vulnerabilities from the OWASP Top 10 for LLMs and NIST AI RMF 1.0.
